...
enum parameters {TAU, KAPPA, LAMBDA, UPSILON, PSI, GAMMA, ETA};
...
class mesh{
    ...
    public:
        void setParameters(float tau,float kappa, float lambda, float upsilon, float psi, float gamma, float eta){
            parameters[TAU]=tau;
