...
void leerMallayCondiciones(mesh &m,char *filename){
    ...
    ifstream file;
    float tau, kappa, lambda, upsilon, psi, gamma, eta;
    ...
    file >> tau >> kappa >> lambda >> upsilon >> psi >> gamma >> eta;
    ...
    m.setParameters((0.25)*tau, kappa, (2/3)*lambda, upsilon, psi, (1/8)*gamma, eta);
